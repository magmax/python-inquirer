...
latex_documents = [
  ('index', 'inquirer.tex', u'inquirer Documentation',
   u'Miguel Ángel García', 'manual'),
]
...
man_pages = [
    ('index', 'inquirer', u'inquirer Documentation',
     [u'Miguel Ángel García'], 1)
]
...
texinfo_documents = [
  ('index', 'inquirer', u'inquirer Documentation',
   u'Miguel Ángel García', 'inquirer', 'One line description of project.',
   'Miscellaneous'),
]
